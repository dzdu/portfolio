...
new TypeIt(".center", {
    ...
    .type(`Would you like to know me better?<br/>
...
new TypeIt("#centerblockthree", {
    ...
    .type("I got some projects done both in MERN, React JS, React Native, Webpack and some UX<br/>", {
        delay: 700
    })
...
new TypeIt("#centerblockfour", {
    ...
    .type(`King regards! <br/> Dzmitry Dudov
    `, {
        delay: 700
    })
    .go();